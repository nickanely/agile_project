...
from MSI_7.check_skip_date import check_skip_date
from MSI_7.image_loader import load_image
from MSI_7.quote_loader import load_quote
from MSI_7.teams_notifier import send_to_teams

with DAG(
        dag_id="MSI_7_skip_holidays_dag",
        description="A simple DAG to send daily quote with image to Teams - skip holidays",
        start_date=pendulum.datetime(2023, 10, 16),
